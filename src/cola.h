...
// Estructura con atributos de un elemento de la cola. Deben tener los campos de atribgrafo.
typedef struct {
...
typedef struct {
    char ubicacionTarea[MAXCHAR];    // Puntero a la habitación del grafo para no reasignar memoria cada vez que se inserta un elemento
    atribtareacola atrib;    // Atributos de la tarea
}tipoelemcola;
